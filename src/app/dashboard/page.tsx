    ...
    <>
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-8 px-4 pb-16 pt-28 sm:px-6 lg:px-10">
        <div className="flex flex-col gap-2">
          <Badge variant="secondary" className="w-fit">Your radar</Badge>
          ...
          <p className="max-w-2xl text-pretty leading-relaxed text-muted-foreground">
            Manage your Radarly account and keep your AI discovery setup ready for what is rising next.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your account identity and membership details.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  <p className="truncate font-heading text-lg font-semibold text-foreground">{user.name || 'Radarly member'}</p>
              ...
              <dl className="grid gap-5 sm:grid-cols-2">
                <div className="flex items-start gap-3">
                  <Mail className="mt-0.5 size-5 text-secondary" aria-hidden="true" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <CalendarDays className="mt-0.5 size-5 text-secondary" aria-hidden="true" />
                  <div>
                    <dt className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Member since</dt>
                    <dd className="mt-1 text-sm font-medium text-foreground">{joinedAt}</dd>
                  </div>
                </div>
              </dl>
            </CardContent>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-foreground">Radar access</span>
                </div>
        ...
        <Card id="settings" className="scroll-mt-24">
          <CardHeader>
            ...
            <CardDescription>Appearance controls are available from the theme button in the navigation. More personalized radar controls are coming soon.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-1 rounded-lg bg-muted p-4">
              <p className="font-medium text-foreground">Personalized signals</p>
              <p className="text-sm leading-relaxed text-muted-foreground">Saved tools, category preferences, and custom alert frequencies will appear here as Radarly expands.</p>
            </div>
          </CardContent>
        </Card>
      </main>
