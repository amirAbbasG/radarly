...
const SOURCES = [
  { title: 'Launch platforms', detail: 'Product launches, upvotes, and early adoption spikes.' },
  { title: 'Developer communities', detail: 'Discussions, questions, and sentiment across forums.' },
  { title: 'Package registries', detail: 'Install trends and dependency growth over time.' },
  { title: 'Release feeds', detail: 'Shipping cadence, changelogs, and version velocity.' },
  { title: 'Social signals', detail: 'Attention velocity, filtered for noise and bots.' },
  { title: 'Editorial review', detail: 'Human checks to catch anomalies the model misses.' },
]
...
export function AboutPage() {
  ...
  return (
    <main className="relative">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <Reveal className="flex flex-col gap-5">
            ...
            <p className="max-w-xl text-pretty leading-relaxed text-muted-foreground">
              New AI tools launch faster than anyone can track. Radarly cuts through the
              flood with one clear promise: show what is actually gaining momentum, ranked by
              real usage instead of marketing budgets. No sponsored slots, no vanity metrics —
              just an honest read on where builders are heading next.
            </p>
            <p className="max-w-xl text-pretty leading-relaxed text-muted-foreground">
              We started Radarly because we were tired of endless top-10 lists that never
              changed. The tools that matter shift week to week, and our radar is built to
              catch that movement the moment it starts.
            </p>
          </Reveal>
      ...
      {/* Methodology */}
      <section id="methodology" className="scroll-mt-20 border-t border-border bg-surface/30">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-10 lg:py-28">
          <Reveal className="mx-auto flex max-w-2xl flex-col items-center gap-4 text-center">
            ...
            <p className="text-pretty leading-relaxed text-muted-foreground">
              Four stages run continuously in the background so the radar stays fresh without
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-start">
          <Reveal className="flex flex-col gap-5 lg:sticky lg:top-28">
            ...
            <p className="max-w-md text-pretty leading-relaxed text-muted-foreground">
              No single source tells the whole story. Radarly blends dozens of independent
              streams so no one platform can distort the picture.
            </p>
          </Reveal>
      ...
      <section id="transparency" className="scroll-mt-20 border-y border-border bg-surface/40">
          ...
          <Reveal className="flex flex-col items-start gap-6 rounded-2xl border border-border bg-card p-8 ring-1 ring-foreground/5 md:flex-row md:items-center md:p-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="max-w-3xl text-pretty leading-relaxed text-muted-foreground">
                Models classify, de-duplicate, and summarize at a scale no team could match by
                hand. But the scoring rules stay transparent and auditable, and every anomaly
                gets a human review before it can move a ranking.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      {/* FAQ */}
      <section id="faq" className="mx-auto max-w-3xl scroll-mt-20 px-4 py-20 sm:px-6 lg:px-10 lg:py-28">
        ...
        <Reveal className="mt-10" delay={0.05}>
          <Accordion defaultValue={['faq-0']} className="rounded-xl border border-border bg-card px-5 ring-1 ring-foreground/5">
            {FAQS.map((f, i) => (
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-10">
        <Reveal className="relative overflow-hidden rounded-2xl border border-border bg-card px-6 py-14 text-center ring-1 ring-foreground/5 md:px-10">
          ...
          <div className="relative mx-auto flex max-w-xl flex-col items-center gap-6">
            ...
            <p className="text-pretty leading-relaxed text-muted-foreground">
              Jump into the live radar, or send us the tools and signals you think we should be
              watching next.
            </p>
            <div className="flex flex-col items-center gap-3 sm:flex-row">
              ...
              <Button size="lg" variant="outline" render={<a href="/public#newsletter" />}>
        ...
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 text-center">
          ...
          <Reveal delay={0.1}>
            <p className="max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Radarly is an always-on radar for the AI tooling world — ranking what&apos;s
              genuinely rising by real usage, not marketing spend. Here&apos;s how it works and
              what we stand for.
            </p>
          </Reveal>
        </div>
